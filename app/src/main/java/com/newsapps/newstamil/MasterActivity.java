...
import com.newsapps.newstamil.widget.SmallWidgetProvider;
...
public class MasterActivity extends OnlineActivity implements HeadlinesEventListener {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (m_prefs.getBoolean("open_fresh_on_startup", false)) {
			...
			{
				HeadlinesFragment hf = new HeadlinesFragment();
				hf.initialize(new Feed(-4, getString(R.string.feed_all_articles), false));
	...
	protected void initMenu() {
		...
		if (m_menu != null && getSessionId() != null) {
			...
			/* if (m_drawerLayout != null) {
                boolean isDrawerOpen = m_drawerLayout.isDrawerOpen(Gravity.LEFT);
	...
	public void onCatSelected(FeedCategory cat) {
		onCatSelected(cat, m_prefs.getBoolean("browse_cats_like_feeds", true));
	}
