...
public class SubscriptionsListAdapter extends BaseExpandableListAdapter {
    ...
    SubscriptionChangeListener mListener;

    public void setListener(SubscriptionChangeListener mListener) {
        this.mListener = mListener;
    }

    public void setGroupList(ArrayList<ArrayList<String>> mGroupList) {
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.check_list_group, null);
...
//                //Callback to expansion of group item
    ...
    private void showTotal(int groupPosition) {
        ...
        mListener.onSubscriptionChanged(sum);
    }
