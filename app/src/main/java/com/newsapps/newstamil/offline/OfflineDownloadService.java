...
import com.newsapps.newstamil.types.FeedCategory;
import com.newsapps.newstamil.util.DatabaseHelper;
...
public class OfflineDownloadService extends Service {
	...
	public static final String INTENT_ACTION_SUCCESS = "com.newsapps.newstamil.intent.action.DownloadComplete";
	public static final String INTENT_ACTION_CANCEL = "com.newsapps.newstamil.intent.action.Cancel";
	...
	private void updateNotification(String msg, int progress, int max, boolean showProgress) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder.setCategory(Notification.CATEGORY_PROGRESS)
                    ...
                    .setColor(0x88b0f0)
                    .setGroup("com.newsapps.newstamil");
        }
	...
	private boolean isCacheServiceRunning() {
	    ...
	    for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
	        if ("ImageCacheService".equals(service.service.getClassName())) {
	            return true;
	        }
	    }
	    return false;
